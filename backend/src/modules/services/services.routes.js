...
import { create, list, get, update, remove, check } from './services.controller.js';
...
router.post('/:id/check', requireAnyRole(ROLES.OWNER, ROLES.ADMIN, ROLES.DEVELOPER), asyncHandler(check));
